...
import cn.fangxinqian.operator.sdk.sign.vo.Sign2ResultVO;
...
public class ContractSign2 {
     ...
     * 签署，返回base64
     */
    private static void sign2ForBase64() throws IOException {


        List<Signer2Area> areaList = new ArrayList<Signer2Area>();
        List<Signer2> signerList = new ArrayList<Signer2>();
        /**
         * 签署区域
         */
        Signer2Area area = new Signer2Area()
                            //签署区域左下⻆点X坐标
                            .setX1(442f)
                            //签署区域左下⻆点Y坐标
                            .setY1(399f)
         ...
         * 签署具体参数
         */
        Sign2DTO sign2DTO = new Sign2DTO()
                            .setAppId(APPID)
         ...
         * 调用签署的方法
         */
        Sign2ResultVO resultVO = SignService.doSign_2(sign2DTO);
     ...
     * 签署，返回云链接
     */
    private static void sign2ForUrl() throws IOException {
        List<Signer2> signerList = new ArrayList<Signer2>();
        /**
         * 第一个签署人签署区域
         */
         ...
         * 第二个签署人的签署区域
         */
        Signer2Area area2 = new Signer2Area()
                //签署区域左下⻆点X坐标
                .setX1(442f)
                //签署区域左下⻆点Y坐标
                .setY1(150f)
                ...
                .setPage(2);
        //存入list
        List<Signer2Area> areaList2 = new ArrayList<Signer2Area>();
        areaList2.add(area2);

        /**
         * 第二个签署人
         */
        Signer2 singer2 = new Signer2()
                    //真实姓名/公司名称
